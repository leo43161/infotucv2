...
const Modal = ({
    ...
    header?: Boolean,    
    className?: string,
    fullHeightContain?: Boolean,
    classNameContain?: string,
    ...
    return createPortal(
        ...
        >
            <div
                className={cn(`rounded-lg shadow-xl flex flex-col overflow-hidden ${sizeClasses}`, classNameContain)}
            ...
            >
                ...
                <div ref={scrollContentRef} className={"overflow-auto  " + (fullHeightContain ? '[&>*:first-child]:h-full' : '')}>
                    <div
