...
import { Hotel, Prestador } from '@/types/api';
import { FaLocationCrosshairs, FaLocationDot } from 'react-icons/fa6';
import { FaFacebook, FaHiking, FaInstagram } from 'react-icons/fa';
                ...
                <div className="grow px-7 flex justify-between gap-4 py-4 items-center">
                    <div className='flex flex-col justify-around grow h-full'>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            {prestador.web && (
                                <div className="flex items-center" onClick={() => handleShowQR("Escanea el QR para acceder a la Web", prestador.web || '')}>
                            ...
                            {prestador.facebook && (
                                <div className="flex items-center" onClick={() => handleShowQR("Escanea el QR para acceder al Facebook", prestador.facebook || '')}>
                                    <div className='flex items-center gap-2 bg-secondary text-zinc-50 px-2 py-1 rounded-xl'>
                            ...
                            {prestador.instagram && (
                                <div className="flex items-center" onClick={() => handleShowQR("Escanea el QR para acceder al Instagram", prestador.instagram || '')}>
                                    <div className='flex items-center gap-2 bg-secondary text-zinc-50 px-2 py-1 rounded-xl'>
                                        <FaInstagram className="size-6" />
                                        <span className="text-xl font-semibold">
                                            Ver Instagram
