...
import { ImagenDestino } from '@/types/itinerario';

// Helper component for image placeholders/error states (sin cambios)
const ImagePlaceholder = ({ size = 48, message } : { size?: number; message?: string }) => (
...
export default function ImageGallery({
    ...
    className?: string;
    classContain?: string;
    classThumbnails?: string;
    classThumbnailActive?: string;
    classImgContain?: string;
    classImg?: string;
                    ...
                    <div className="relative overflow-hidden md:min-h-full h-[360px]">
                        {hasCurrentError ? (
                            ...
                            <img
                                ...
                                className="w-full h-full object-contain rounded border-amber-300"
