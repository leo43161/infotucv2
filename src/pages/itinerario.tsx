...
import { useGetItinerarioQuery } from '@/store/services/itinerarioService';
import { useRouter } from 'next/router';
import ItinerarioMobile from '@/components/itinerario/ItinerarioMobile';
...
Itinerario.getLayout = function getLayout(page : SVGAElement) {
  return page;
};