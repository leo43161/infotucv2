...
export default function autos() {
  ...
  const cacheKey = 'getAutos?' + getNameCacheKeyWithArgs({ offset, limit: itemsPerPage });
  const { data: autos, isLoading } = useOfflineQuery(
    useGetAutosQuery,
        ...
        <div className='grow z-[1]'>
          <div className='flex flex-col h-full justify-start'>
            ...
            <div className='flex flex-col gap-4 py-2 px-8'>
              {autos?.result?.map((auto: Auto, index : number) => (
